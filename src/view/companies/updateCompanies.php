<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="updateCompaniesForm" action="" method="post">
                    <?php include_once(_DEMO_PATH_ . 'lib/msg.inc.php'); ?>
                    <input type="hidden" name="action" id="action" value="update">
                    <input type="hidden" name="id" id="id" value="<?php // $objCompanie->getId_companie() ?>">
                    <input type="text" name="id_companie" id="id_companie" value="<?= $objCompanie->getId() ?>" />
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="companiesJs.fUpdate()">Salvar</button>
                    </div>
                </form>
            </div>
        </div>
